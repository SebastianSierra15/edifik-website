...
import { useRegisterUser } from "@/src/hooks/auth";
import { StepEmail } from "./register/StepEmail";
import { StepPersonalData } from "./register/StepPersonalData";
...
export function RegisterForm() {
  ...
  const { registerUser, loading: registering } = useRegisterUser();
