...
import { ProjectMedia, ImageType, SimpleCatalog } from "@/src/interfaces";
...
export function PropertyMediaGallery({
  ...
  const imagesByCommonArea = commonAreas
    .map((area) => ({
      areaName: area.name,
...
function ImageSection({ category, images, onImageClick }: ImageSectionProps) {
  return (
    <div className="mb-6">
