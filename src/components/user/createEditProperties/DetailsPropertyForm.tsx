...
import { ProjectFormData, SimpleCatalog } from "@/src/interfaces";
...
interface DetailsPropertyFormProps {
...
export function DetailsPropertyForm({
  formData,
  onChange,
  onPrevious,
  onNext,
  ...
  const { errors, validateFields, validateField } = useDetailsProjectValidation(
    formData,
    true
  );
