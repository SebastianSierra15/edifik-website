...
export default function AdminHeader() {
  ...
  const menuItems = [
    ...
    { path: "/admin/membresias", label: "Membresias" },
    { path: "/admin/peticiones", label: "Peticiones" },
  ];

  return (
    <div className="fixed top-0 left-0 z-30 w-full bg-premium-background dark:bg-premium-secondaryDark bg-opacity-90 shadow-md text-premium-textPrimary dark:text-premium-textPrimary">
