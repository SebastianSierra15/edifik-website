    ...
    const marker = L.marker(position, {
      icon: L.divIcon({
        html: `<button class="text-white font-semibold py-2 px-3 rounded-full shadow-md ${
          isSelected
            ? "bg-primaryDark dark:bg-primaryDark" // Cuando el marcador está seleccionado
            : "bg-primary dark:bg-primary hover:bg-primaryLight focus:outline-none focus:bg-primaryDark"
