          ...
          <thead className="thead-light text-xs">
            <tr>
              {Array.from({ length: columns }).map((_, index) => (
                <th
                  key={index}
                  className="px-4 py-2 text-left text-premium-textPrimary dark:text-premium-textPrimary"
                >
                  <div className="h-6 w-20 rounded bg-gray-300 dark:bg-gray-700" />
                </th>
              ))}
              <th className="px-4 py-2 text-left text-premium-textPrimary dark:text-premium-textPrimary">
                <div className="h-6 w-20 rounded bg-gray-300 dark:bg-gray-700" />
              </th>
            </tr>
          </thead>
